...
def analyze(preds: Path, refs: Path, *, top_k: int, include_matches: bool, labels: Sequence[str] | None) -> None:
    ...
    _print_report(counts, totals, top_k=top_k, include_matches=include_matches, requested=labels)
